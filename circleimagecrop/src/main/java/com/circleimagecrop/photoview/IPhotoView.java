 ...
 *******************************************************************************/
package com.circleimagecrop.photoview;
...
public interface IPhotoView {
    ...
    /**
     * SignUp a callback to be invoked when the Photo displayed by this view is long-pressed.
     *
    ...
    /**
     * SignUp a callback to be invoked when the Matrix has changed for this View. An example would
    ...
    /**
     * SignUp a callback to be invoked when the Photo displayed by this View is tapped with a
     * single tap.
     *
     * @param listener - Listener to be registered.
     */
    ...
    /**
     * SignUp a callback to be invoked when the View is tapped with a single tap.
     *
     * @param listener - Listener to be registered.
     */
